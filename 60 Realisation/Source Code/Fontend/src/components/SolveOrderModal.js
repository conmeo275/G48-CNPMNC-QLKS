...
export class SolveOrderModal extends Component {
    ...
    constructor(props) {
        super(props);
        this.state ={orders:[],emps:[], snackbaropen: false,snackbarmsg:'', selectedType : 'A',DateSolve:'',Days:'',selectedNum:''};
        ...
        event.preventDefault();
          fetch('/updateorder/'+event.target.ID.value,{
            ...
            body:JSON.stringify({
              ...
              isPaid:event.target.isPaid=true
          ...
          .then((result)=>
          {
            ...
            const room = this.state.emps.find(e => e.roomnum === this.props.roomnum);          
